 ...
 * This example is based on the Stochastic Shortest Path defined in the journal  Tangent number 75
 * 
 * In this way we build an MDP object without transition matrices. The transition matrices are added after the building of the mdp
 */
